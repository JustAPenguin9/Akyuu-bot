  ...
  run: (bot, message, args) => {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "if you're new to AOCF, use **!starthere**", value: 'this will get you the links to SonofGod1998 starterpack complete with everything you need to play.' },
